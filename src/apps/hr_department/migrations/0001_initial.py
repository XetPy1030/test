    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('childrens', models.ManyToManyField(default=[], null=True, to='hr_department.children')),
                ('education', models.ManyToManyField(default=[], null=True, to='hr_department.education')),
            ],
        ),
        migrations.CreateModel(
            name='DraftEmployeeInformation',
            fields=[
                ('formfield_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='hr_department.formfield')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user_id', models.TextField()),
                ('owner_id', models.TextField()),
            ],
            bases=('hr_department.formfield',),
        ),
        migrations.CreateModel(

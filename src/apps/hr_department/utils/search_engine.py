...
def search_by_full_name(full_name: str, max_length: int) -> QuerySet[ServerEmployeeInformation]:
    server_employee_information = ServerEmployeeInformation.objects.filter(full_name=full_name)[:max_length]

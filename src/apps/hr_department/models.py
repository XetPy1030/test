...
class Education(models.Model):
    ...
    photo = models.ImageField(default="pictures/default.jpeg", null=True)
...
class FormField(models.Model):
    ...
    passport_reversal_photo = models.ImageField(default="pictures/default.jpeg", null=True)
    ...
    military_document_photo = models.ImageField(default="pictures/default.jpeg", null=True)

    # many to many
    children = models.ManyToManyField(Children, default=[])

    snils_number = models.TextField(default=None, null=True, blank=True)
    snils_photo = models.ImageField(default="pictures/default.jpeg", null=True)
    inn_number = models.TextField(default=None, null=True, blank=True)
    inn_photo = models.ImageField(default="pictures/default.jpeg", null=True)
    ...
    work_permit_photo = models.ImageField(default="pictures/default.jpeg", null=True)
    ...
    residence_photo = models.ImageField(default="pictures/default.jpeg", null=True)
    ...
    patent_photo = models.ImageField(default="pictures/default.jpeg", null=True)
    ...
    temporary_residence_permit_photo = models.ImageField(default="pictures/default.jpeg", null=True)
    migration_card_photo = models.ImageField(default="pictures/default.jpeg", null=True)
    notice_of_registration_in_russia_photo = models.ImageField(default="pictures/default.jpeg", null=True)

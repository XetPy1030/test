...
ssh -o StrictHostKeyChecking=no $SERVER_USER@$SERVER_IP "docker run --net elastic -v /var/lib/postgresql/hr_data/pictures:/usr/src/web/src/pictures -d -p 8000:8000 --name backend $TAG_COMMIT"

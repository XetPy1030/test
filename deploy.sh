...
ssh -o StrictHostKeyChecking=no $SERVER_USER@$SERVER_IP "docker run --net pg_db --net elastic --env-file=/home/dell-dev/.env -d -p 8000:8000 --name backend $TAG_COMMIT"

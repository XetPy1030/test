...
ssh -o StrictHostKeyChecking=no $SERVER_USER@$SERVER_IP "docker run --net elastic -v ./pictures:/var/lib/postgresql/hr_data/pictures -d -p 8000:8000 --name backend $TAG_COMMIT"
